...
export class DeliveredTrackingComponent implements OnInit, AfterViewInit, OnDestroy {
  x = 0.000010;
  msg: any;
  bookingId: any;
  userId: any;
  ...
  getDirection() {
    this.service.post('admin/tracking/delivered/details', { 'booking_id': this.bookingId }).subscribe(res => {
      this.trackData = res['result'];
      this.origin = {
        lat: this.trackData.deliever_source_location[1],
        lng: this.trackData.deliever_source_location[0]
      };
      this.destination = {
